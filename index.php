    ...
    <div>
      ...
      <div class="main-container">
        ...
        <div class="main-container002">
          ...
          <option value='all' selected>--Підрозділ--</option>
          <?php
              $temp = 4;
              $sql0 = "SELECT elementname FROM global where id > 3";
              $result = mysqli_query($con, $sql0) or die (mysqli_error($con));
      ...
      <form method="post">
        ...
        <div class="main-container254">
          ...
          <div class="vl"></div>
          <input
            type="Підрозділ" id="act_num" name="act_num"
          ...
          <div class="vl"></div>
          <input
            type="Підрозділ" id="act_all_year" name="act_all_year"
            placeholder="Роки"
            class="main-textinput8 input"
          />
        ...
        if (isset($_REQUEST["select2"])) {
          ...
          // New query to get the value of $type1 from the global table
          $type1Query = "SELECT * FROM `global` WHERE `id` = $type1";
          $type1Result = mysqli_query($con, $type1Query) or die(mysqli_error($con));
          $type1Row = mysqli_fetch_assoc($type1Result);
          $type1Value = $type1Row['id']; // Replace 'column_name' with the actual column name in your global table
      
          if ($type1Value == "all" AND $year1 == "all") {
              $sql = "SELECT * FROM res_amount where str_el > 3 and str_el < 14 and resource = $pokaznik order by year, month, str_el;";
              $this1 = 10;
          } elseif ($type1Value == "all") {
              $sql = "SELECT * FROM res_amount where str_el > 3 and str_el < 14 and resource = $pokaznik AND year = $year1 order by month, str_el;";
              $this1 = 10;
          } elseif ($year1 == "all") {
              $sql = "SELECT * FROM res_amount WHERE str_el = $type1Value AND resource = $pokaznik";
          } else {
              $sql = "SELECT * FROM res_amount WHERE str_el = $type1Value AND year = $year1 AND resource = $pokaznik";
          }
          ...
          echo '<div class="main-container036">
                    <span class="main-text034">
                      Показник ' . $pokaznik . ' в року ' . $year1 . ' в структурі ' . $type1Value . '
                    </span>
        ...
        if (isset($_REQUEST["select10"])) {
          ...
          <div class="main-container256">
            ...
            <div class="main-container260"><span>Підрозділ</span></div>
        ...
        if (isset($_REQUEST["select11"])) {
          ...
          <div class="main-container274"><span>Підрозділ</span></div>
      ...
      if (isset($_REQUEST["select12"])) {
        ...
        echo '<div class="main-container272">
          <div class="main-container273">
          <div class="main-container274"><span>Підрозділ</span></div>
          <div class="main-container275"><span>ааощаджений ресурс</span></div>
          <div class="main-container276">
            <div class="main-container277">
              <span class="main-text395">Існуюча ситуація</span>
              <div class="main-container278">
